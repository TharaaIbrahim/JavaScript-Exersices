...
3- Favorite Movie (4)
*/
const favFood=['IceCream','Burger','potato','rice','chicken'];
const favSport=['Basketball','Football','Tennis'];
const favMovie=['Escape room','run','gifted hands','100 days to live'];
...
function middleOfArray(arr){
    if((arr.length-1)%2!==0){
        return `${arr[arr.length/2]} and ${arr[arr.length/2-1]}`;
    }else{
