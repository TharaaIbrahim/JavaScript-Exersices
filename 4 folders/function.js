...
function tellFortune(jobTitle,geoLocation,partnerName,numOFChildern){
   console.log(`You will be a ${jobTitle} in ${geoLocation},and married to ${partnerName} with ${numOFChildern} kids`);
}
/*
2
